...
TrackWidget::TrackWidget(QWidget *parent) : QWidget(parent) {
  ...
  QPixmap comma_img = loadPixmap("../assets/img_spinner_comma.png").scaled(screenBG_spinner_size, Qt::KeepAspectRatio, Qt::SmoothTransformation);
  QPixmap track_img = loadPixmap("../assets/img_spinner_track.png").scaled(spinner_size, Qt::KeepAspectRatio, Qt::SmoothTransformation);
