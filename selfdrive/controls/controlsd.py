...
# Neokii's live tune
    ...
    if not self.joystick_mode:
      ...
      actuators.accel = self.LoC.update(self.active, CS, self.CP, long_plan, pid_accel_limits, self.sm['radarState'])
...
#          self.events.add(EventName.steerSaturated)
  ...
  def publish_logs(self, CS, start_time, actuators, lac_log):
    ...
    hudControl.leadvRel = self.sm['radarState'].leadOne.vRel
    hudControl.leadVisible = self.sm['longitudinalPlan'].hasLead
    hudControl.leadDistance = self.sm['radarState'].leadOne.dRel
