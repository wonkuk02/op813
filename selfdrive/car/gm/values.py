...
class CarControllerParams():
  ...
  STEER_DRIVER_FACTOR = 100  # revert <- qadmus, eps torque to steer command units, flatten CarControllerParams
...
STEER_THRESHOLD = 1.0 # CarControllerParams.STEER_DRIVER_ALLOWANCE  # qadmus, eps torque to steer command units, flatten CarControllerParams

class CAR:
  HOLDEN_ASTRA = "HOLDEN ASTRA RS-V BK 2017"
  VOLT = "CHEVROLET VOLT PREMIER 2018"
